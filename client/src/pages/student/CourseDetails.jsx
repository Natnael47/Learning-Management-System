            ...
            <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                <div className='max-w-xl z-10 text-gray-500'>
                    ...
                    <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                        ...
                        <div className='flex'>
                            {[...Array(5)].map((_, i) => (<img className='w-3.5 h-3.5' src={i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank} key={i} alt="" />
                            ))}
                        </div>
                    ...
                    <p className='text-sm'>Course by <span className='text-blue-600 underline'>Natnael</span></p>
                        ...
                        <div className='pt-5'>
                            {courseData.courseContent.map((chapter, index) => (
                                <div className='border border-gray-300 bg-white mb-2 rounded' key={index}>
                                    <div className='flex items-start justify-between px-4 my-3 cursor-pointer select-none' onClick={() => toggleSection(index)}>
                ...
                {/* right column */}
                <div className='max-w-[424px] z-10 shadow-custom-card rounded-t md:rounded-none overflow-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
                    {
                    ...
                    <div className='p-5'>
                        ...
                        <div className='pt-6 '>
                            ...
                            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                                ...
                                <li>Certificatio of completion</li>
                            </ul>
                        </div>
                    </div>
                </div>
